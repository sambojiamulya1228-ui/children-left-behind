            ...
            <section className="wpo-about-area stay">
                <div className="container" style={bg}>
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6" style={{paddingLeft: "110px",marginTop:"140px",marginBottom:"60px"}}>
                        ...
                        <div className="col-md-6" style={{marginBottom: "-162px"}}>
                            <img src={heroImg} alt="" />
                        </div>
                    </div>
                </div>
...
<br></br>
                    ...
                    <br></br>
                    <ul>
                        <li style={{listStyle: "none", position: "relative", paddingLeft: "20px"}}><span style={{position: "absolute", left: "0", fontSize: "24px", fontWeight: "bold"}}>.</span>India has the third highest HIV/AIDS rate in the world, with an estimated 2.4 million people living  with the disease</li><br></br>
                        <li  style={{listStyle: "none", position: "relative", paddingLeft: "20px"}}><span style={{position: "absolute", left: "0", fontSize: "24px", fontWeight: "bold"}}>.</span>Due to widespread child malnutrition, more children under age 5 are underweight in India  than in any other country in the world. Nearly 45% of Indian children struggle with inadequate nutrition</li><br></br>
                        <li style={{listStyle: "none", position: "relative", paddingLeft: "20px"}}><span style={{position: "absolute", left: "0", fontSize: "24px", fontWeight: "bold"}}>.</span>Over a quarter of India’s population lives below  the poverty line, meaning families and children in  poverty cannot afford basic goods</li> <br></br>
                        <li style={{listStyle: "none", position: "relative", paddingLeft: "20px"}}><span style={{position: "absolute", left: "0", fontSize: "24px", fontWeight: "bold"}}>.</span>Close to 70% of India’s population lacks adequate sanitation and drainage systems. This creates a breeding ground for such diseases as hepatitis A & C, typhoid fever and bacterial infections</li><br></br>
